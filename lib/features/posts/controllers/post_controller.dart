...
import 'package:knowme_frontend/features/posts/repositories/post_repositories.dart';
...
class PostController extends GetxController {
  ...
  final Rx<String?> selectedActivityPeriod = Rx<String?>(null);
  ...
  void resetFilters() {
    switch (currentTabIndex.value) {
      ...
      case 2: // 대외활동
        ...
        selectedActivityPeriod.value = null;
        break;
      case 3: // 교육/강연
      ...
      case 2: // 대외활동
        switch (filterType) {
          ...
          case '주최기관':
            ...
            break;
          case '기간':
            selectedActivityPeriod.value = value;
            break;
        }
        break;
      case 3: // 교육/강연
